...
<section id="content">
    ...
    <div class="main-content d-flex justify-content-center align-items-center">
        <div class="container d-flex flex-column align-items-center justify-content-center position-relative">
            <form action="{{ route('verificationComp', $competition->id) }}" method="POST" class="text-center">
                @method('put')
                @csrf
                ...
                <div class="input-form position-relative">
                    ...
                    <input type="text" name="nama_tim" id="form-input"
                        class="form-input px-4 bg-secondary bg-opacity-10" value="{{ $competition->name }}" required
                        readonly>
                    <span class="req position-absolute">*</span>
                </div>
                <div class="input-form position-relative">
                    <p class="label position-absolute">Email</p>
                    <input type="email" name="email_tim" id="form-input"
                        class="form-input px-4 bg-secondary bg-opacity-10" value="{{ $competition->email }}" required
                        readonly>
                    <span class="req position-absolute">*</span>
                </div>
                <div class="input-form position-relative">
